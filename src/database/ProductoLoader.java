...
public class ProductoLoader {
    public static List<Producto> cargarProductos(){
        return new ArrayList<Producto>(
                Arrays.asList(
                        new Producto(1L, "P001", "Laptop HP", 15000.0f,
                                "Electronica",5, new ArrayList<Venta>()),
                        new Producto(2L, "P002", "Smartphone Samsung", 8000.0f,
                                "Electronica",3,new ArrayList<Venta>()),
                        new Producto(3L, "P003", "Televisor LG", 12000.0f,
                                "Electronica",5,new ArrayList<Venta>()),
                        new Producto(4L, "P004", "Zapatillas Nike", 2000.0f,
                                "Calzado",2,new ArrayList<Venta>()),
                        new Producto(5L, "P005", "Jeans Levi's", 1500.0f,
                                "Ropa",2,new ArrayList<Venta>()),
                        new Producto(6L, "P006", "Reloj Casio", 1000.0f,
                                "Ropa",1,new ArrayList<Venta>()),
                        new Producto(7L, "P007", "Botella de vino tinto", 500.0f,
                                "Bebidas",3,new ArrayList<Venta>()),
                        new Producto(8L, "P008", "Caja de chocolates", 200.0f,
                                "Dulces",0,new ArrayList<Venta>())
                )
        );
    }
    ...
    public static Producto getProductoCinco(){
        return new Producto(5L, "P005", "Jeans Levi's", 1500.0f,
                "Ropa",2,new ArrayList<Venta>());
    }

    public static Producto getProductoSeis(){
        return new Producto(6L, "P006", "Reloj Casio", 1000.0f,
                "Ropa",1,new ArrayList<Venta>());
    }
